...
<<<<<<< HEAD
=======
import Interventi from './pages/Interventi.jsx';
...
=======
                    <Link className="navbar-brand d-flex align-items-center" to="/">
                        <img
                            src="/assets/LOGO CROCE.jpg"
                            alt="Croce d'Oro Sud Pontino logo"
                            className="me-2"
                            style={{ height: '32px', width: '32px', objectFit: 'cover' }}
                        />
                        {isPrivate ? 'Area Privata' : "Croce d'Oro Sud Pontino"}
                    </Link>
>>>>>>> d11cca6 (first commit)
...
=======
                                    ...
                                    <li className="nav-item">
                                        <Link className="nav-link" to="/diventare-volontario">Come diventare volontario</Link>
                                    </li>
                                    <li className="nav-item">
                                        <Link className="nav-link" to="/richiedere-servizio">Come richiedere il servizio</Link>
                                    </li>
                                    <li className="nav-item">
                                        <a className="nav-link" href="#footer">Contatti</a>
                                    </li>
                                    <li className="nav-item">
                                        <Link className="nav-link" to="/login">Area Riservata</Link>
                                    </li>
>>>>>>> d11cca6 (first commit)
                                </>
                            )}
                                ...
                                <div className="row mt-4">
                                    <div className="col-md-6 mb-3">
                                        <div className="d-flex align-items-start">
                                            <span className="fs-2 me-3">🚑</span>
                                            <div>
                                                <h5>Trasporti privati con ambulanza</h5>
                                                <p>Servizio di trasporto sanitario per visite mediche, terapie e trasferimenti ospedalieri.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-md-6 mb-3">
                                        <div className="d-flex align-items-start">
                                            <span className="fs-2 me-3">🚨</span>
                                            <div>
                                                <h5>Emergenza sanitaria 118</h5>
                                                <p>Intervento rapido in situazioni di emergenza in collaborazione con il servizio 118.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-md-6 mb-3">
                                        <div className="d-flex align-items-start">
                                            <span className="fs-2 me-3">📚</span>
                                            <div>
                                                <h5>Formazione PBLSD-PTC-corso soccorritore</h5>
                                                <p>Corsi di formazione certificati per volontari e cittadini in tecniche di primo soccorso.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-md-6 mb-3">
                                        <div className="d-flex align-items-start">
                                            <span className="fs-2 me-3">🚧</span>
                                            <div>
                                                <h5>Protezione civile-AIB</h5>
                                                <p>Attività di protezione civile e Anti Incendio Boschivo per la sicurezza del territorio.</p>
>>>>>>> d11cca6 (first commit)
                                            </div>
                                        </div>
                                    </div>
